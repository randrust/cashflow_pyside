...
################################################################################
## Form generated from reading UI file 'new_transjKWMaV.ui'
##
...
class Ui_FormNew(object):
    def setupUi(self, FormNew):
        if not FormNew.objectName():
            FormNew.setObjectName(u"FormNew")
        FormNew.resize(264, 385)
        self.layoutWidget = QWidget(FormNew)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(11, 10, 247, 339))
        ...
        self.retranslateUi(FormNew)

        QMetaObject.connectSlotsByName(FormNew)
    # setupUi

    def retranslateUi(self, FormNew):
        FormNew.setWindowTitle(QCoreApplication.translate("FormNew", u"NEW RECORD", None))
        self.label_3.setText(QCoreApplication.translate("FormNew", u"\u0414\u0430\u0442\u0430", None))
        self.lc1000.setText(QCoreApplication.translate("FormNew", u"1000 x", None))
        self.lc500.setText(QCoreApplication.translate("FormNew", u"500 x", None))
        self.lc200.setText(QCoreApplication.translate("FormNew", u"200 x", None))
        self.lc100.setText(QCoreApplication.translate("FormNew", u"100 x", None))
        self.lc50.setText(QCoreApplication.translate("FormNew", u"50 x", None))
        self.e1000.setText(QCoreApplication.translate("FormNew", u"=", None))
        self.e500.setText(QCoreApplication.translate("FormNew", u"=", None))
        self.e200.setText(QCoreApplication.translate("FormNew", u"=", None))
        self.e100.setText(QCoreApplication.translate("FormNew", u"=", None))
        self.e50.setText(QCoreApplication.translate("FormNew", u"=", None))
        self.lsc1000.setText(QCoreApplication.translate("FormNew", u"1000 x", None))
        self.lsc500.setText(QCoreApplication.translate("FormNew", u"500 x", None))
        self.lsc200.setText(QCoreApplication.translate("FormNew", u"200 x", None))
        self.lsc100.setText(QCoreApplication.translate("FormNew", u"100 x", None))
        self.lsc50.setText(QCoreApplication.translate("FormNew", u"50 x", None))
        self.label_2.setText(QCoreApplication.translate("FormNew", u"\u0421\u0443\u043c\u0430", None))
        self.label.setText(QCoreApplication.translate("FormNew", u"100000", None))
        self.OkButton.setText(QCoreApplication.translate("FormNew", u"OK", None))
        self.CancelButton.setText(QCoreApplication.translate("FormNew", u"Cancel", None))
    # retranslateUi
